<footer class="site-footer container text-center px-0" id="colophon">
    <div class="site-info shadow border-light border border-top-0 bg-theme bg-gradient text-light px-3 py-2 py-md-4 mx-2 mx-lg-0">
        <small>
