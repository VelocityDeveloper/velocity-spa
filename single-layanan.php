		...
		<?php while ( have_posts() ) : the_post(); ?>
            <div class="row mb-2">
                ...
                <div class="col-md-7 col-12 mt-4 mt-md-0">
                    ...
                    <?php endif;?>
                    <a href="https://api.whatsapp.com/send?phone=<?php echo $nowa; ?>&text=Hallo saya mau pesan layanan ini : <?php echo get_the_title(); ?> dari <?php echo get_site_url(); ?>" target="_blank" class="btn btn-success text-uppercase fw-bold text-light p-2 my-2">
                    ...
                    <article <?php post_class('col-md-3 col-6 px-2 container border-0 mb-3'); ?> id="post-<?php the_ID(); ?>">
                        <div class="card h-100 p-0 border-0">
                            ...
                            <div class="halCircles bg-colortheme text-white">
                                <a href="https://api.whatsapp.com/send?phone=<?php echo $nowa; ?>&text=Hallo saya mau pesan layanan ini : <?php echo get_the_title(); ?> dari <?php echo get_site_url(); ?>" target="_blank" class="btn w-100 text-uppercase fw-bold text-light p-2">Booking</a>
                            </div>
                        </div>
                    </article><!-- #post-## -->
            	<?php endwhile;?>
